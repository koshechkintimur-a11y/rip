-- =============================================================
-- RIP · миграция 0015 — фикс эхо: scheduled-крики тоже решаются волной
--
-- Баг: слоты, купленные в очередь (scheduled, starts_at в будущем),
-- не активировались и не умирали в волне — накапливались навсегда
-- и сдвигали starts_at новых криков в будущее.
-- Теперь волна решает судьбу всех не-мёртвых криков сезона:
-- active и scheduled.
-- =============================================================
